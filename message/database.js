...
if (!isNumber(users.limit)) users.limit = 30
...
if (!("antisange" in chats)) chats.antisange = true
if (!("antinsfw" in chats)) chats.antinsfw = true
if (!("autorespongc" in chats)) chats.autorespongc = true
...
if (!("autorespon" in settings)) settings.autorespon = true
